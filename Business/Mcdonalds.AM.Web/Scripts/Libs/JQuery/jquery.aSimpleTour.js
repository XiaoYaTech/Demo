...
(function ($) {
    ...
    var settings = {
        ...
        autoStart: false,
        controlsPosition: 'TR',
        welcomeMessage: '<p>First time here?</p>',
        buttons: {
            next: 'Next',
            prev: 'Previous',
            start: 'Start',
    ...
    var methods = {
        init: function (opts) {
          ...
          <div id="tourButtons">\
            <button id="tourPrev" class="btn btn-sm btn-primary" style="display:none">'+ options.buttons.prev + '</button>\
            <button id="tourNext" class="btn btn-sm btn-warning">' + options.buttons.start + '</button>\
            <a href="javascript:void(0);" class="pd_t_7" id="tourEnd" style="display:none; color: #fff; text-decoration: underline; font-size: 12px; float: right">'+ options.buttons.end + '</a>\
          </div>\
        </div>';

...
!function () {
    ...
    ctrlModule.controller('amNoticesListCtrl', [
        ...
        "$selectStore",
        "amNoticesService",
        ($scope, $http: ng.IHttpService, $modal: ng.ui.bootstrap.IModalService, $window: ng.IWindowService, $selectStore, amNoticesService) => {
            $scope.pageIndex = 1;
            $scope.pageSize = 10;
            $scope.totalItems = 0;
            $scope.list = [];
            ...
            $scope.pagging = function () {
                ...
                amNoticesService.getItemsList($scope.pageSize, $scope.pageIndex, $scope.searchCondition)
            ...
            $scope.searchStore = (inputCode) => { // 下拉US Code列表
        ...
        .controller("amNoticesDetailCtrl", [
            ...
            "$routeParams",
            "amNoticesService",
            ($scope, $http, $routeParams, amNoticesService) => {
                $scope.noticeId = $routeParams.noticeId;
                
                amNoticesService.getItemDetail( $scope.noticeId )
                    .then(function (response) {

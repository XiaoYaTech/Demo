rebuildApp.controller("tempClosureMemoController", [
    '$scope',
    '$routeParams',
    "$location",
    "$selectUser",
    ...
    function ($scope, $routeParams, $location, $selectUser,$window, taskWorkService, tempClosureService,redirectService, messager) {
        ...
        //tempClosureService.querySaveable({ projectId: $scope.projectId }).$promise.then(function (data) {
        //    messager.unBlockUI();
                ...
                OnUserSelected: function (users) {
                    ...
                    tempClosureService.sendClosureMemo({
                        ...
                        messager.showMessage("[[[发送成功]]]", "fa-check c_green").then(function () {
                            ...
                            redirectService.flowRedirect("Rebuild_TempClosureMemo", $scope.projectId);
                        });
                    }, function (response) {
                        messager.unBlockUI();

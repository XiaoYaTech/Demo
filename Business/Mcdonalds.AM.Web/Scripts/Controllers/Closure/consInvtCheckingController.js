dictionaryApp.controller('consInvtCheckingController', [
    '$scope',
    "$http",
    "$routeParams",
    "$modal",
    ...
    function ($scope, $http, $routeParams, $modal, $window, closureCreateHandler, messager, redirectService) {
      ...
      */
            ...
            $modal.open({
                ...
                var url = Utils.ServiceURI.Address() + "api/ClosureConsInvtChecking/PostClosureConsInvtChecking";
                ...
                $http.post(url, $scope.entity).success(function () {

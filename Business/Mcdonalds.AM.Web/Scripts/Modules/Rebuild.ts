...
angular.module("mcd.am.modules.rebuild", ["nttmnc.fx.modules", "mcd.am.service.taskwork"])
    .directive("rebuildLeaseChange", [
        "$http", "rebuildService", ($http: ng.IHttpService, rebuildService) => {
            return {
                restrict: "EA",
                scope: {
                    source:"=?",

...
{
    public class RebuildCoverExcelData : ExcelDataBase
    {
        public RebuildCoverExcelData(FileInfo fileInfo)
            : base(fileInfo)
        {
            SheetName = "PMT";
        }
        ...
        public override void Input(ExcelWorksheet worksheet, ExcelInputDTO inputInfo)
        {
            ...
            worksheet.Cells["B8"].Value = inputInfo.TempClosureDate;
            worksheet.Cells["B9"].Value = inputInfo.ReopenDate;
